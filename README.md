...
>
> - When using **ARSEEDING** as storage, you need to ***deposit*** a certain amount of ***ETH*** to ***EverPay*** to cover storage, computation, data, and other costs. You can learn more about EverPay at:
...
- **Parameters**
  ...
  - **dataUserPk:** The user's public key generated by keygen.
...
- **Parameters**
  ...
  - **dataUserSk**: The user's secret key generated by keygen.
